...
for epoch in range(1, num_epochs + 1):
    ...
    if eval_loss < best_loss_eval:
        torch.save(lenet_model.state_dict(), os.path.join(SAVE_MODEL_DIR, 'lenet_model.pt'))
...
lenet_model.load_state_dict(torch.load(os.path.join(SAVE_MODEL_DIR, 'lenet_model.pt')))
test_acc, test_loss = evaluate(lenet_model, criterion, test_dataloader)
print("Kết quả độ chính xác trên tập test là", test_acc)